 ...
 */
public class RobotSwerveDriveExecuteFigure8 {

	public static void main(String[] args) throws IOException {

		String currentWorkingDir = System.getProperty("user.dir");
		String filename = currentWorkingDir + "/figure8_input_files/swerve_figure8.txt";
		List<JoystickInput> commands = Commands.readFileSingleInput(filename);

		Robot robot = new Robot(new SwerveRobotDrive(new Table(5), 0, 0, Facing.EAST));
